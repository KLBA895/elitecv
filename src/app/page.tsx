...
const content = {
  de: {
    ...
    whyText: [
      ...
      "Recruiter verstehen deine Stärken in Sekunden - nicht erst nach 5 Minuten Lesen.",
    ],
    ...
    faqs: [
      ...
      { q: "Ist EliteCV für verschiedene Branchen geeignet?", a: "Ja. Sprache, Fokus und Struktur werden auf deine Zielrolle angepasst." },
      { q: "Kann ich eine Korrekturrunde anfordern?", a: "Ja, alle Pakete enthalten mindestens eine strukturierte Revision." },
    ],
    contactTitle: "Kontakt",
    contactText: "Fragen zu Paketen, Abläufen oder deinem Profil? Kontaktiere uns unverbindlich.",
    contactEmailLabel: "E-Mail",
    contactFormName: "Name",
    contactFormEmail: "E-Mail",
    contactFormMessage: "Nachricht",
    contactFormSubmit: "Nachricht senden",
    finalTitle: "Bereit für deinen nächsten Karriereschritt mit EliteCV?",
  ...
  en: {
    ...
    legalLinks: [
      ...
      { label: "Withdrawal", href: "/widerrufsrecht" },
      { label: "Contact", href: "#kontakt" },
    ],
