        ...
        <div className="mt-6 rounded-2xl border border-[#0A1F44]/10 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <button
              ...
              className={`rounded-xl px-4 py-2 text-sm font-semibold transition ${data.layout === "professional"
            ...
            <button
              ...
              className={`rounded-xl px-4 py-2 text-sm font-semibold transition ${data.layout === "executive"
                ? "bg-[#0A1F44] text-white"
                : "border border-[#0A1F44]/15 text-[#0A1F44]/70"
                }`}
            >
